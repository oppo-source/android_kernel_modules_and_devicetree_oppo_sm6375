...
/*add for Stereo Speaker connected over AUX_OUT + EAR_OUT, KBA-230822235420, case 06833683, case 06786652.*/
#define WCD_CLSH_STATE_EAR_AUX_HPHL (WCD_CLSH_STATE_EAR | \
				       WCD_CLSH_STATE_AUX | \
				       WCD_CLSH_STATE_HPHL)
#define WCD_CLSH_STATE_EAR_AUX_HPHR (WCD_CLSH_STATE_EAR | \
				       WCD_CLSH_STATE_AUX | \
				       WCD_CLSH_STATE_HPHR)
#define WCD_CLSH_STATE_EAR_AUX_HPH_ST (WCD_CLSH_STATE_EAR | \
				       WCD_CLSH_STATE_AUX | \
