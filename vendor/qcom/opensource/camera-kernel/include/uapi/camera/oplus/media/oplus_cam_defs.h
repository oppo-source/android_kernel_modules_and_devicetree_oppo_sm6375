...
#define CAM_OIS_AGING_SET_WORKING_THREAD        (CAM_OEM_COMMON_OPCODE_BASE + 0x10)
#define CAM_OIS_AGING_SET_TARGET                (CAM_OEM_COMMON_OPCODE_BASE + 0x11)
#define CAM_OIS_AGING_GET_ACTUAL                (CAM_OEM_COMMON_OPCODE_BASE + 0x12)
#define CAM_OIS_AGING_GET_KMD_LOOP_DONE         (CAM_OEM_COMMON_OPCODE_BASE + 0x13)

#define CAM_OEM_CMD_READ_DEV                    0
#define CAM_OEM_CMD_WRITE_DEV                   1
#define CAM_OEM_OIS_CALIB                       2
#define CAM_OEM_RW_SIZE_MAX                     128
#define OIS_AGING_LOOP_DATA_NUM                 120
...
typedef struct oisaging_set_target_t
{
	uint32_t workingPeriod;
	uint32_t writeReadInterval;
	uint32_t targetCodeMap[OIS_AGING_LOOP_DATA_NUM];
} OISAGING_SET_TARGET;
...
#define VIDIOC_CAM_SENSOR_STATR_NO_WRITE_IZOOM 0x9002
