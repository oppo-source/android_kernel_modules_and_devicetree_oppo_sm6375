...
struct cam_ois_ctrl_t {
	...
	struct task_struct *oisaging_work_thread;
	wait_queue_head_t oisaging_work_wq;
	int oisaging_need_work;
	struct mutex oisaging_work_mutex;
	uint32_t oisaging_set_thread;
	struct oisaging_set_target_t set_target;
#endif
};
