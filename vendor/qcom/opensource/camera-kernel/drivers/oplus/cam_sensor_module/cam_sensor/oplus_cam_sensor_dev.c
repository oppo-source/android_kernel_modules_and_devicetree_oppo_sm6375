...
#include "init_camera_setting/imx355_setting.h"
#include "init_camera_setting/imx882_setting.h"
#include "init_camera_setting/gc08a_setting.h"
#include "init_camera_setting/s5kjnssq33_setting.h"
#include "init_camera_setting/gc32e2_setting.h"
};
	...
	case VIDIOC_CAM_FTM_POWNER_UP:
		...
		*is_ftm_current_test = 1;
		...
		case IMX355_SENSOR_ID:
			...
			break;
		case IMX882_SENSOR_ID:
			ptr = &sensor_settings.imx882_setting;
			break;
		case S5KJNSSQ33_SENSOR_ID:
			ptr = &sensor_settings.s5kjnssq33_setting;
			break;
		case GC08A_SENSOR_ID:
			ptr = &sensor_settings.gc08a_setting;
			break;
		case GC32E2_SENSOR_ID:
			ptr = &sensor_settings.gc32e2_setting;
			break;
		default:
			break;
		}
	...
	if (rc == 0) {
		...
		if(s_ctrl->sensor_initsetting_state == CAM_SENSOR_SETTING_WRITE_INVALID){
			...
			case OV32C_SENSOR_ID:
				...
				break;
			case IMX355_SENSOR_ID:
				ptr = &sensor_init_settings.imx355_setting;
				CAM_INFO(CAM_SENSOR, "IMX355_SENSOR_ID");
				break;
			case IMX882_SENSOR_ID:
				ptr = &sensor_init_settings.imx882_setting;
				CAM_INFO(CAM_SENSOR, "IMX882_SENSOR_ID");
				break;
			case GC08A_SENSOR_ID:
				ptr = &sensor_init_settings.gc08a_setting;
				CAM_INFO(CAM_SENSOR, "GC08A_SENSOR_ID");
				break;
			case S5KJNSSQ33_SENSOR_ID:
				ptr = &sensor_init_settings.s5kjnssq33_setting;
				CAM_INFO(CAM_SENSOR, " S5KJNSSQ33_SENSOR_ID");
				break;
			case GC32E2_SENSOR_ID:
				ptr = &sensor_init_settings.gc32e2_setting;
				CAM_INFO(CAM_SENSOR, "GC32E2_SENSOR_ID");
				break;
			default:
