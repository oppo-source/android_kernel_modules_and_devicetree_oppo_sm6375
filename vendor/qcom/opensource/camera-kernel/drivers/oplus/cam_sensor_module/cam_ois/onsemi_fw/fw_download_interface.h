...
int32_t oplus_cam_ois_construct_default_power_setting_dw9786(struct cam_sensor_power_ctrl_t *power_info);
int32_t oplus_cam_ois_construct_default_power_setting_dw9785(struct cam_sensor_power_ctrl_t *power_info);
