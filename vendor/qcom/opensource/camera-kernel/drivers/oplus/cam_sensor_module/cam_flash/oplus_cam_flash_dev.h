...
struct cam_flash_ftm_settings {
	...
	struct cam_flash_ftm_reg_setting flashlow1ledsettings;
...
int oplus_cam_flash_proc_init(struct cam_flash_ctrl *flash_ctl, struct platform_device *pdev, struct i2c_client *client);
