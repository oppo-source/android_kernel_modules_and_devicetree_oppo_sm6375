 ...
 static void lcd_bias_i2c_remove(struct i2c_client *client);
...
EXPORT_SYMBOL(lcd_bias_set_vspn);
/*****************************************************************************
 * Data Structure
 *****************************************************************************/
...
EXPORT_SYMBOL(lcd_bias_init);
void lcd_bias_exit(void)
{
    platform_driver_unregister(&lcd_bias_platform_driver);
    i2c_del_driver(&lcd_bias_i2c_driver);
}
EXPORT_SYMBOL(lcd_bias_exit);
