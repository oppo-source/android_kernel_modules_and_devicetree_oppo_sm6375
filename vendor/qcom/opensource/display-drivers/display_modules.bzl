...
module_entry(
      ...
      config_srcs = {
         ...
         "OPLUS_FEATURE_DISPLAY" : [
             "oplus/oplus_dsi_support.c",
             "oplus/oplus_display_private_api.c",
             "oplus/oplus_dc_diming.c",
             "oplus/oplus_ffl.c",
             "oplus/oplus_display_panel.c",
             "oplus/oplus_display_panel_power.c",
             "oplus/oplus_display_panel_seed.c",
             "oplus/oplus_display_panel_common.c",
             "oplus/oplus_display_esd.c",
             "oplus/oplus_bl.c",
             "oplus/oplus_display_panel_feature.c",
             "oplus/oplus_display_interface.c",
             "oplus/oplus_display_high_frequency_pwm.c",
         ],
         "OPLUS_FEATURE_DISPLAY_ADFR" : [
             "oplus/oplus_adfr.c",
         ],
         "OPLUS_FEATURE_DISPLAY_TEMP_COMPENSATION" : [
             "oplus/oplus_display_temp_compensation.c",
         ],
         "OPLUS_FEATURE_DISPLAY_ONSCREENFINGERPRINT" : [
             "oplus/oplus_onscreenfingerprint.c",
         ],
