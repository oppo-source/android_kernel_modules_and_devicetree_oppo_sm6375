...
static struct kthread_worker g_omrg_worker;
...
static struct attribute *omrg_attrs[] = {
#else
...
static int omrg_probe(struct platform_device *pdev)
{
	...
	kthread_init_worker(&g_omrg_worker);
